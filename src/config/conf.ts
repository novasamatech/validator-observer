...
export const config = new Config(
  [
    new RelaychainConfig('Kusama Asset Hub', 'wss://asset-hub-kusama-rpc.n.dwellir.com', [
      {
    ...
    new RelaychainConfig('Polkadot Asset Hub', 'wss://rpc-assethub.novasama-tech.org', [
      {
    ...
    new AstarConfig('Astar', 'wss://astar.api.onfinality.io/ws?apikey=8422f83b-f495-4e4b-b3f5-1d1c88a3f940', [
      {
    ...
    new KiltConfig('Kilt', 'wss://spiritnet.kilt.io', [
      {
